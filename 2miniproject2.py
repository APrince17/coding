...
for weeks in range(17):
    if grade/17 > 100: grade = 100
    grade = int(input(f"Grade for week {weeks + 1}: ")) + grade
    weeks = weeks + 1
    print(f"Current GPA: {grade/weeks}")
else: print(f"Your grade average is " + str(grade/17))
...
if figrade >= 50 and figrade < 60: print(f"Your letter grade is an F") 
if figrade >= 50 and figrade < 60: gradeletter = "F"
if figrade >= 60 and figrade < 70: print(f"Your letter grade is a D") 
if figrade >= 60 and figrade < 70: gradeletter = "D"
if figrade >= 70 and figrade < 80: print(f"Your letter grade is a C")
if figrade >= 70 and figrade < 80: gradeletter = "C"
if figrade >= 80 and figrade < 90: print(f"Your letter grade is a B") 
